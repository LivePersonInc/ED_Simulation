...
public class SimResults_diff{
    ...
    protected double[] sumWdiff;
    protected int[] counterDiff;
    ...
    public SimResults_diff( int n){
        ...
        this.sumWdiff = new double[100];
        this.counterDiff = new int[100];
    } 
    ...
    public void registerDeparture(Patient p, double t){
        ...
        double tw = p.getWaitingTime();
        int nrVisits = p.getNrVisits();
        ...
        sumTotalW += tw;
        sumTotalW2 += tw*tw;
        sumWdiff[nrVisits] += tw;
        counterDiff[nrVisits] ++;
    }
    ...
    public double[] getMeanInnerWait(){
        double[] out = new double[sumWdiff.length];
        
        for( int i = 0; i < out.length; i++ ){
            out[i] = sumWdiff[i]/counterDiff[i];
        }
